...
- (void) login:(CDVInvokedUrlCommand*)command {
  [GIDSignIn.sharedInstance signInWithConfiguration:[self getGIDSignInObject:command] presentingViewController:self.viewController callback:^(GIDGoogleUser * _Nullable user, NSError * _Nullable error) {
    if (error) {
